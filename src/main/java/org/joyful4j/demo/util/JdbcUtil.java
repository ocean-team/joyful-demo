package org.joyful4j.demo.util;
...
//        }
        ...
        DBCP_DATA_SOURCE.setDriverClassName(ConfigHelper.getJdbcDriver());
        DBCP_DATA_SOURCE.setUrl(ConfigHelper.getJdbcUrl());
        DBCP_DATA_SOURCE.setUsername(ConfigHelper.getJdbcUsername());
        DBCP_DATA_SOURCE.setPassword(ConfigHelper.getJdbcPassword());
